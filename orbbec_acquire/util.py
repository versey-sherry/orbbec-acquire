...
def start_recording(base_dir, subject_name, session_name, recording_length, 
    ...
    p_bottom = Process(target=capture_from_camera, 
                       args=(pipeline, config, filename_prefix , recording_length),
